...
OPTIONS = {
    'input_folder': '/home/baitaluk/Projects/Historic_12092019',
    'postgresql': {
    ...
    'ds': {
        'dataset': {
            'fields': ['dataset_id', 'ip_version', 'modified_at', 'country',
        ...
        'links': {
            'fields': ['an0', 'an1', 'asn0', 'asn1', 'rank0', 'rank1', 'rank', 'range', 'number_paths', 'relationship',
                       'asn0_cone', 'asn1_cone', 'locations', 'corrected_by', 'date', 'ts']},
        'cones': {
            'fields': ['aid', 'rank', 'asn', 'cone', 'asns', 'pfx', 'range', 'date', 'ts']},

        'prefixes': {
            'fields': ['asn', 'network', 'length', 'origin', 'range', 'date', 'ts']},

        'locations': {
            'fields': ['locid', 'city', 'country', 'continent', 'region', 'population', 'longitude', 'latitude', 'range', 'date', 'ts']},
