...
OPTIONS = {
    ...
    'ds': {
        ...
        'cones': {
            'fields': ['aid', 'rank', 'asn', 'cone', 'asns', 'pfx', 'range', 'valid_date_first', 'valid_date_last']},

        'prefixes': {
            'fields': ['asn', 'network', 'length', 'origin', 'range', 'valid_date_first', 'valid_date_last']},
