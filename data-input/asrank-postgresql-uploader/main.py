...
from gii.gii import PostgresImporter
...
def args_parser():
    ...
    parser.add_argument("-m", "--mode", required=False, type=str, default='single', help="Upload mode [single or all]. By default 'single'.")
...
if __name__ == '__main__':
    ...
    startt = datetime.now()
    try:
        idb = PostgresImporter(args_parser())
        idb.start()
