...
DEBUG = True
DEBUG_DBNAME = 'bhuffakew'
DEBUG_DIR = '../data-test'
DEBUG_RURL = 'http://127.0.0.1:8000/as_core/'
...
=======
    OPTIONS['input_folder'] = DEBUG_DIR
    OPTIONS['influxdb']['dbname'] = DEBUG_DBNAME
    OPTIONS['rurl'] = DEBUG_RURL
>>>>>>> 4d7041ec720acadd2b259d5ba379639a53d6bf63

# Loggging
logging.config.fileConfig('config/logging.ini')
logger = logging.getLogger(OPTIONS['influxdb']['dbname'])
